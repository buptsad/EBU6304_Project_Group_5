...
/**
 * ViewModel for the IncomeExpensesReportPanel following the MVVM pattern.
 * Acts as an intermediary between the income/expenses chart panel and the finance data model.
 * <p>
 * Features:
 * <ul>
 ...
 */
public class IncomeExpensesReportViewModel implements DataRefreshListener {
    ...
    /**
     * Constructs an IncomeExpensesReportViewModel with the given FinanceData.
     * Registers for data refresh events.
     *
     * @param financeData the finance data model
     */
    public IncomeExpensesReportViewModel(FinanceData financeData) {
